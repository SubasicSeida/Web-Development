...
CREATE TABLE `properties` (
  ...
  `property_type` enum('townhouse','apartment','villa','studio') NOT NULL,
...
INSERT INTO `properties` VALUES (2,'Modern Apartment in Sarajevo','A beautiful 2-bedroom apartment in the center of Sarajevo.',250000.00,'apartment',80,NULL,'Sarajevo',NULL,'sale',2,1,3,'2025-04-01 19:24:34');
...
CREATE TABLE `users` (
  ...
  `user_role` enum('customer','agent') DEFAULT NULL,
...
-- Dump completed on 2025-04-01 21:52:11
